...
export function SystemStatus() {
  const [endpoints, setEndpoints] = useState<EndpointStatus[]>([
    { name: "Authentication API", url: "/auth/me", status: "checking" },
    { name: "Products API", url: "/products", status: "checking" },
    { name: "Cart API", url: "/cart", status: "checking" },
    { name: "Discounts API", url: "/discounts", status: "checking" },
    { name: "Transactions API", url: "/transactions", status: "checking" },
  ])
  ...
  const checkAllEndpoints = async () => {
    setEndpoints((prev) => prev.map((endpoint) => ({ ...endpoint, status: "checking" })))
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              {getStatusIcon(overallHealth === "healthy" ? "healthy" : "unhealthy")}
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  {endpoint.responseTime && (
                    <div className="text-sm text-muted-foreground">{endpoint.responseTime}ms</div>
                  )}
