...
import { ShoppingBag, ShoppingCart, CreditCard, Info, Shield, Menu, X, User, Settings } from "lucide-react"
...
export function MainNavigation() {
  ...
  const filteredAdminItems = adminItems.filter(
    (item) => (!item.requireAuth || isAuthenticated) && (!item.requireRole || user?.role === item.requireRole),
  )
